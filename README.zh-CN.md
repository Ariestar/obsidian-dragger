...
- 🔗 **多选拖拽** — 使用手柄或原生文本选区选择多个块，然后拖动任一选中手柄移动整组内容
...
**多选拖拽：** 长按（触屏）、点击多个手柄，或使用跨块原生文本选区，然后拖动任一选中手柄移动整个选区。按 **Escape** 退出多选。
